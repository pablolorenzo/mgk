"""
Django settings for mgk project.
...
SECRET_KEY = 'django-insecure-ax!_hm)!5ck0!g_ta61th227cwdr$%7ya+-092n(tbk=lq4^ae'
...
WSGI_APPLICATION = 'mgk.wsgi.application'
